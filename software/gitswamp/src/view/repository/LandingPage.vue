  ...
  <div class="flex-1 overflow-y-auto bg-[var(--background)]">
    <div class="max-w-7xl mx-auto px-8 py-6">
      ...
      <div class="flex items-center justify-between gap-2 mb-6">
        ...
        <div class="flex items-center gap-2">
          <button @click="emit('logs')" class="px-4 py-2 bg-[var(--secondary)] hover:opacity-80 text-[var(--foreground)] text-xs font-medium rounded-md border border-[var(--border)] transition-colors flex items-center gap-2">
